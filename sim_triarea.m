function [area] = sim_triarea(P,method)
%
%************** FWP Work ************************
...
%
% [area] = sim_triarea(Points, Method)
%
...
% area = sim_triarea([P1;P2;P3])
%
% Version 1.1 updated on 2007-09-21 
% Added 'Orthogonal-triangular decomposition' after a usefull review of John D'Errico 

% Default output format
% Modified by Feng W.P, IGP/CEA, 2009-11
% Add the function into my package and change the function name into
% sim_triarea.
% 
%
